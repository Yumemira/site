import '../../styles/Mobile/contentOneStyleM.css';
import PageBlock from '../PageBlock';

export default function BlockContentOneM(){
    return <PageBlock MyClass={"content--one"}>
        ...
        <h1 id='content--one-header-main' className='content--one-text'>Всё для счастливой жизни в одном месте</h1>
            <div className='content--one-inline'><p>Вся инфраструктура для комфортной жизни, работы и отдыха находится рядом с вашим домом:</p>
